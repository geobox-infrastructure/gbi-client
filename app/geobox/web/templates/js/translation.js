OpenLayers.Lang['en'] = OpenLayers.Util.applyDefaults({
    ...
    'Zoom to layer extent': "{{ _('Zoom to layer max extent') }}",
    'visibility': "{{ _('Change visibility') }}",
    'setActive': "{{ _('Activate layer') }}",
    ...
    "Max autogenerated colors reached": "{{ _('Max autogenerated colors reached') }}",
    "Unselect filtered features": "{{ _('Unselect filtered features') }}",
